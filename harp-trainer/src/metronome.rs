...
/// A simple metronome that plays short sine-wave clicks via CPAL output.
...
impl Metronome {
    ...
    fn start_output(trigger: Arc<Mutex<bool>>) -> Option<Stream> {
        ...
        // Click parameters: 880Hz sine, ~40ms duration with fast exponential decay
        let click_freq = 880.0f32;
        let click_samples = (sample_rate * 0.04) as usize; // 40ms
        ...
        let stream = device
            .build_output_stream(
                ...
                move |data: &mut [f32], _: &cpal::OutputCallbackInfo| {
                    // Check if a new click was triggered
